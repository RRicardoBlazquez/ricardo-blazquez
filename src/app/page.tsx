...
export default function Home() {
  return (
    <main className="flex w-full flex-col items-center justify-between my-40">
      <section className='h-auto w-full flex items-center justify-center'>
        <div className='flex flex-row flex-wrap w-full h-80 items-center gap-y-8'>
          ...
          <div className=' w-full sm:w-1/2 h-80 sm:h-auto flex flex-col items-center'>
            <Image src={"/ricardoPerfil.jpg"} alt='Foto mia' width={901} height={1600} className='w-auto h-60' />
